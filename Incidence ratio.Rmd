...
ny_zips <- ny_zips #%>% filter(substr(ZCTA5CE10, 1, 3) %in% nyc_zips)
...
ggplot() +
 ...
 # scale_fill_viridis_c(name = "Value") +
  theme_minimal() +
  labs(title = "New York State ZIP Code Choropleth Map by age group (2016-2020)")+
    theme(panel.background = element_rect(color = "white", fill = "white")) +
    scale_fill_stepsn('Incidence', breaks= 1:100, limits = c(0,100), labels=plotlabs,
                      colors=inferno(20),
